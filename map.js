...
window.Map17 = (function () {
  ...
  var ENTRIES = [
    ...
    { id: "the-study",      n: "04", name: "The study I ran",
      kind: "result",     say: "The undergraduate research project, walked through, including the parts that were wrong.",
      sims: [], topic: null },
    ...
    { id: "projects",       n: "07", name: "Things I built for students",
      kind: "observation", say: "What gets made when the equipment is not there.",
      sims: [], topic: null },
    { id: "bench",          n: "08", name: "At the bench",
      kind: "observation", say: "The practical work, and what a small budget teaches you.",
      sims: [], topic: null },
    { id: "long-way-round", n: "09", name: "The long way round",
      kind: "reflection", say: "The grades, said out loud rather than hidden. They went up every year.",
      sims: [], topic: null },
    ...
    { id: "currently",      n: "12", name: "Currently",
      kind: "reflection", say: "What is happening right now, dated so you can tell if it has gone stale.",
      sims: [], topic: null },
  ...
  var COUNTS = {
    ...
    /* how many entries have something runnable in them, and how many
       simulation instances that is between them */
    entriesLive: ENTRIES.filter(function (e) { return e.sims.length; }).length,
    simsInEntries: ENTRIES.reduce(function (n, e) { return n + e.sims.length; }, 0),
